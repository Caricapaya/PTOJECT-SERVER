	...
	private JSONObject handleSendLocation(JSONObject request){
		...
		switch (sessionStatus){
			...
			case DeviceSessionManager.SESSION_REFRESH:
				...
				//add device to list of online devices with the given location
			...
			case DeviceSessionManager.SESSION_ACTIVE:
				...
				System.out.println("Sender is" + (designatedAreaManager.isOnCampus(temp) ? "" : " not") + " on campus");
				System.out.println("Sender is in: " + designatedAreaManager.currentArea(temp));
			break;
		}
